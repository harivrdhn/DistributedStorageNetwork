...
public class BroadcastDecoderPipeline implements ChannelPipelineFactory {
	private BroadcastHandler handler = new BroadcastHandler();

	public BroadcastDecoderPipeline() {
		System.out.println("inside constructor of BroadcastDecoderPipeline");
	}

	public void addListener(ClientListener listener) {
		System.out.println("inside addListener of  -------  BroadcastDecoderPipeline");
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		pipeline.addLast("protobufDecoderRes", new ProtobufDecoder(eye.Comm.Response.getDefaultInstance()));
